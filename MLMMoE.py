...
history = model.fit(x=train_model_input, y={'finish':train['finish'].values, 'like':train['like'].values},validation_split=0.3,
                    callbacks=[EarlyStopping(monitor='val_loss', patience=2, verbose=0, mode='auto')],batch_size=4096, epochs=20, verbose=1)
