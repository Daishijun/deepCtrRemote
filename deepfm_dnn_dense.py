#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time     : 2019/8/22 10:40
# @Author   : Daishijun
# @Site     : 
# @File     : deepfm_dnn_dense.py
# @Software : PyCharm
...
def DeepFM(linear_feature_columns, dnn_feature_columns, embedding_size=8, use_fm=True, use_only_dnn=False,dnn_hidden_units=(128, 128),
    ...
    dnn_logit = tf.keras.layers.Dense(
        1, use_bias=False, activation=None)(dnn_out_2)
